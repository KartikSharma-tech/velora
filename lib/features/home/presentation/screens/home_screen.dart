...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  // which intentionally clears the stack so users can't go "back"
  // into the auth flow. That means Home has nothing left to pop, so
  // a hardware/gesture back press here used to fall straight
  // through to the OS and kill the app instantly — no confirmation,
  // felt like a crash. This adds the standard "press back again to
  // exit" pattern instead.
